...
프로젝트의 전체적인 기능과 사용법을 확인할 수 있는 시연 영상입니다.

[![Dividend Portfolio 시연 영상](https://img.youtube.com/vi/6MUyV6vp1ig/0.jpg)](https://www.youtube.com/watch?v=6MUyV6vp1ig)

**📺 [YouTube 시연 영상 보기](https://www.youtube.com/watch?v=6MUyV6vp1ig)**

- **프로젝트 소개**: 전체적인 구조와 주요 기능 설명
- **실제 사용법**: 각 기능별 상세한 사용 방법
- **데모 시연**: 실제 데이터를 활용한 포트폴리오 구성
